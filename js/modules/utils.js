// js/modules/utils.js
export const DIFFICULTY_NAMES = { easy: 'Fácil', medium: 'Médio', hard: 'Difícil', custom: 'Personalizado' };
...
export const MODE_MEDALS = {
  default: [
    { id: 'accuracy', icon: '🎯', name: 'Precisão Total', req: '≥ 90% Precisão' },
    { id: 'time15', icon: '⚡', name: 'Relâmpago', req: 'Tempo ≤ 15s' },
    { id: 'time30', icon: '🥈', name: 'Arrancada', req: 'Tempo ≤ 30s' },
    { id: 'speed60', icon: '🥇', name: 'Mestre', req: '50+ PPM' }
  ],
  fury: [
    { id: 'fury_50', icon: '🔥', name: 'Fúria Incontrolável', req: 'Streak de 50 caracteres' },
    { id: 'fury_100', icon: '⚡', name: 'Raio Furioso', req: 'Streak de 100 caracteres' }
  ],
  survival: [
    { id: 'survive_5', icon: '❤️', name: 'Sobrevivente', req: 'Completar com 5 vidas' },
    { id: 'survive_1', icon: '💀', name: 'Quase Morto', req: 'Completar com 1 vida' }
  ],
  sniper: [
    { id: 'sniper_perfect', icon: '🎯', name: 'Atirador de Elite', req: '0 erros na frase' },
    { id: 'sniper_comeback', icon: '🔄', name: 'Recuperação', req: 'Completar após 2 erros' }
  ],
  wordhunt: [
    { id: 'hunt_10', icon: '🧩', name: 'Caçador Iniciante', req: 'Encontrar 10 palavras' },
    { id: 'hunt_20', icon: '🏆', name: 'Mestre Caçador', req: 'Encontrar 20 palavras' }
  ],
  casino: [
    { id: 'casino_500', icon: '💰', name: 'Milionário', req: 'Acumular 500 fichas' },
    { id: 'casino_lucky', icon: '🍀', name: 'Sorte Grande', req: 'Ganhar 3 apostas seguidas' }
  ],
  marathon: [
    { id: 'marathon_50', icon: '🏃', name: 'Maratonista', req: '50 palavras em 60s' },
    { id: 'marathon_100', icon: '🚀', name: 'Usain Bolt', req: '100 palavras em 60s' }
  ],
  memory: [
    { id: 'memory_perfect', icon: '🧠', name: 'Mente de Elefante', req: '100% de memória' },
    { id: 'memory_fast', icon: '⏱️', name: 'Memória Relâmpago', req: 'Completar em < 5s' }
  ],
  wave: [
    { id: 'wave_10', icon: '🌊', name: 'Surfista', req: 'Completar 10 ondas' },
    { id: 'wave_perfect', icon: '🏄', name: 'Onda Perfeita', req: 'Todas as ondas sem erro' }
  ],
  rpg: [
    { id: 'rpg_lv5', icon: '⚔️', name: 'Guerreiro', req: 'Alcançar nível 5' },
    { id: 'rpg_lv10', icon: '🛡️', name: 'Cavaleiro', req: 'Alcançar nível 10' },
    { id: 'rpg_100_hits', icon: '💥', name: 'Combo Perfeito', req: '100 acertos no RPG' }
  ],
  rainbow: [
    { id: 'rainbow_full', icon: '🌈', name: 'Arco-Íris Completo', req: 'Pintar toda a frase' },
    { id: 'rainbow_fast', icon: '✨', name: 'Pintor Veloz', req: 'Pintar em < 10s' }
  ]
};
...
export const ACHIEVEMENTS_LIST = [
  ...
  { id: 'level_5', icon: '🌟', title: 'Aprendiz', desc: 'Alcançar nível 5 global' },
  { id: 'level_10', icon: '🌟', title: 'Discípulo', desc: 'Alcançar nível 10 global' },
  { id: 'level_25', icon: '🌟', title: 'Mestre', desc: 'Alcançar nível 25 global' },
  { id: 'level_50', icon: '🌟', title: 'Lenda', desc: 'Alcançar nível 50 global' },
  { id: 'battle_10', icon: '⚔️', title: 'Guerreiro Iniciante', desc: 'Vença 10 batalhas no RPG' },
  { id: 'battle_50', icon: '⚔️', title: 'Herói', desc: 'Vença 50 batalhas no RPG' },
  { id: 'battle_100', icon: '⚔️', title: 'Lendário', desc: 'Vença 100 batalhas no RPG' },
  { id: 'perfect_10', icon: '🎯', title: 'Perfeccionista', desc: '10 rodadas perfeitas (100% precisão)' },
  { id: 'perfect_50', icon: '🎯', title: 'Mestre da Perfeição', desc: '50 rodadas perfeitas' },
  { id: 'perfect_100', icon: '🎯', title: 'Deus da Precisão', desc: '100 rodadas perfeitas' },
  { id: 'rpg_win_50', icon: '👑', title: 'Rei do RPG', desc: 'Vença 50 batalhas no modo RPG' },
];
...
export const state = {
  ...
  customUserText: localStorage.getItem('customUserText') || '',
  isTimerMode: false,
  timerModeLimit: 30,
  ...
  currentText: '',
  timerInterval: null,
  modeStats: JSON.parse(localStorage.getItem('mestre_mode_stats')) || {},
  userStats: JSON.parse(localStorage.getItem('mestre_user_stats')) || {
...
export function saveState() {
  ...
  localStorage.setItem('customUserText', state.customUserText);
}

export function getModeStats(modeId) {
  if (!state.modeStats[modeId]) {
    state.modeStats[modeId] = {
      ppmHistory: [],
      bestPPM: 0,
      bestAccuracy: 0,
      bestTime: null,
